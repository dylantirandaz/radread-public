...
## role:reviewer
A passing trial answers every task in the authorized key (243 for the released cohort).
...
default `verifier/gold.json`. Use the complete authorized key for all 243 released tasks.
